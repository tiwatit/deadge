...
function Footer({id,image}) {
  ...
  return (
    <div className='relative w-screen h-[10vh] text-[20px] lg:h-[30vh] lg:text-[45px] flex flex-col justify-center items-center font-light cursor-pointer' style={{background:`url(${image})`,marginTop:'20px'}} onClick={()=>navigate(`/deadge/projects/${arr[id]}`)}>
